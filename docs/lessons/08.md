...
| `s`           | `char*`               | Character string (not quoted). Pointing to an array of characters large enough for the string and a terminating `'\0'` that will be added.                                                     |
